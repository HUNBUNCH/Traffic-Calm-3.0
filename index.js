...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.tapToStartScreen}]}).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance_1},{t:this.menuScreen}]},1).to({state:[{t:this.inGameScreen}]},1).to({state:[{t:this.loseScreen}]},1).to({state:[{t:this.winScreen}]},1).wait(1));
